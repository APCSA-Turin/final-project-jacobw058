    ...
    public ArrayList<Tile> getBlockTileList() {
        ...
        if (!getRotated()) {
            if (getRotation() % 2 == 0) {
                ...
                result.set(13, new Tile("🟦",1, true));
                result.set(14, new Tile("🟦", 1, true));
                result.set(15, new Tile("🟦", 1, true));
            }
        }
        setRotated(true);
        return result;
